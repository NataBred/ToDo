package com.example.todo.task.show.done
...
import kotlinx.android.synthetic.main.fragment_done_tasks.button_create_task
import kotlinx.android.synthetic.main.fragment_done_tasks.recycler_view_done_task
import kotlinx.android.synthetic.main.fragment_done_tasks.toolbar_done
...
class DoneTasksFragment : Fragment() {
  ...
  private fun initToolbar() {
    toolbar_done.inflateMenu(R.menu.menu_toolbar_main)
  }

  private fun initNotesRecyclerView() {
    recycler_view_done_task.layoutManager = LinearLayoutManager(requireContext())
    recycler_view_done_task.adapter = adapter
  }
  ...
  private fun handleToolbarDeleteAllClicked() {
    toolbar_done.setOnMenuItemClickListener {
